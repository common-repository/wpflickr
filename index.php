<?php
/*
Plugin Name: WPFlickr
Plugin URI: http://blog.zhourunsheng.com
Description: Handles uploading, modifying images on Flickr, and insertion into posts. 上传和编辑 Flickr 账户中的图片，并且在博文中插入Flickr账户中的图片，利用Flickr做图床。
Version: 1.1.0
Author: Carey Zhou
Author URI: http://blog.zhourunsheng.com

Copyright 2012  Carey Zhou  (email : zhourunsheng2008@gmail.com)
...
class FlickrManager extends BasePlugin
{
	...
	function ApplyDefaults() 
	{
		$defaults = array(
			...
			'api_key' => '7e8216e469b1b6ce4070b330a7f4f644'
			,'secret' => '8b0ea506bffec958'
			,'per_page' => 5
            ,'cache' => 'db'
            ,'recent_widget' => array(
	...
	function RegisterPluginLinks($links, $file) {
		...
		if($file == $base) {
			...
			$links[] = '<a href="http://blog.zhourunsheng.com/" title="Support">Support</a>';
			$links[] = '<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&amp;business=zhourunsheng2008%40gmail%2ecom&amp;lc=AU&amp;currency_code=AUD">Donate</a>';
		}
